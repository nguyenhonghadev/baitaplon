...
<html lang="vi">
<?php
require('../back_end_btl/config/connect.php');
?>
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <?php
    $doan = "Đồ ăn";
    $sql_sanpham = mysqli_query($conn, "SELECT * FROM products WHERE prd_category = '$doan' ORDER BY prd_id DESC");

    while ($row_sanpham = mysqli_fetch_array($sql_sanpham)) {
        // Hiển thị sản phẩm
        ?>
        <div class="col-lg-3 col-md-6 text-center food">
            <div class="single-product-item">
                <div class="product-image">
                    <a href="./HTML/chitietsanpham.html"><img src="image/đồ ăn/cá chép om dưa.webp" alt=""></a>
                </div>
                <h3><?php echo $row_sanpham['prd_name']; ?></h3>
                <div style="text-align: center; margin-bottom: 10px;">
                    <div class="product-price name-product" style="display: inline-block; margin-right: 10px; font-family: 'Poppins', sans-serif; font-size: 30px; font-weight: 700;"><?php echo $row_sanpham['prd_price']; ?>đ</div>
                </div>
...
<div class="row product-lists">
    <?php
    $douong = "Đồ Uống";
    $sql_sanpham = mysqli_query($conn, "SELECT * FROM products WHERE prd_category = '$douong' ORDER BY prd_id DESC");
    ...
    while ($row_sanpham = mysqli_fetch_array($sql_sanpham)) {
        ...
        <div class="col-lg-4 col-md-6 text-center drinking">
            <div class="single-product-item">
                <div class="product-image">
                    <a href="./HTML/chitietsanpham.html"><img src="image/đồ uống/7 up.jpg" alt=""></a>
                </div>
                <h3>7 Up</h3>
                <div style="text-align: center; margin-bottom: 10px;">
                    <div class="product-price name-product" style="display: inline-block; margin-right: 10px; font-family: 'Poppins', sans-serif; font-size: 30px; font-weight: 700;"><?php echo $row_sanpham['prd_price']; ?>đ</div>
                    <div class="strike-price" style="display: inline-block; margin-right: 10px;"><strike>20.000đ</strike></div>
                </div>
                <p>Còn lại:20</p>
                <button style=" font-family: 'Poppins', sans-serif; display: inline-block; background-color: #F28123; color: #fff; padding: 10px 20px; border: none; border-radius: 2em; " class="cart-btn"><i class="fas fa-shopping-cart "></i> Thêm vào giỏ Hàng</button>
            </div>
...
<div class="row product-lists">
    <?php
    $tm = "Đồ Tráng Miệng";
    $sql_sanpham = mysqli_query($conn, "SELECT * FROM products WHERE prd_category = '$tm' ORDER BY prd_id DESC");
    ...
    while ($row_sanpham = mysqli_fetch_array($sql_sanpham)) {
        ...
        <div class="col-lg-4 col-md-6 text-center desert">
            <div class="single-product-item">
                <div class="product-image">
                    <a href="./HTML/chitietsanpham.html"><img src="image/tráng miệng/hoa quả tổng hợ.jpg" alt=""></a>
                </div>
                <h3>Hoa Quả Tổng Hợp</h3>
                <div style="text-align: center; margin-bottom: 10px;">
                    <div class="product-price name-product" style="display: inline-block; margin-right: 10px; font-family: 'Poppins', sans-serif; font-size: 30px; font-weight: 700;"><?php echo $row_sanpham['prd_price']; ?>đ</div>
                    <div class="strike-price" style="display: inline-block; margin-right: 10px;"><strike>120.000đ</strike></div>
                </div>
                <button style=" font-family: 'Poppins', sans-serif; display: inline-block; background-color: #F28123; color: #fff; padding: 10px 20px; border: none; border-radius: 2em; " class="cart-btn"><i class="fas fa-shopping-cart "></i> Thêm vào giỏ Hàng</button>
            </div>
        </div>
